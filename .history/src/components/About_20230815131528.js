            ...
            <div className="container mt-5 ">
                <div className="row">
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        ...
                        <p>NoteOn is made from the pain of writing all the things in notebook which is very hectic :(, So we mad an online web platform where you can create, edit, upload, delete your notes/information privately and securely without any disturbancee.
                ...
                <div className="row login mt-5 mb-5 p-5">
                    ...
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        ...
                        <p>
                            How we started? The concept was simple. NoteOn was born from the pain of writing all the things in notebook which is very hectic :( .
            ...
            <footer>
                <div className="content">
                    ...
                    <div className="link-boxes">
                        ...
                        <ul className="box input-box">
                            <li className="link_name">About NoteOn</li>
                ...
                <div className="bottom-details">
                    <div className="bottom_text">
                        <span className="copyright_text">Copyright © 2021 <Link to="/">NoteOn</Link>All rights reserved</span>
